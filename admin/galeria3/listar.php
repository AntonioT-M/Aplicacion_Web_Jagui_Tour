		...
		if (respuesta == true) {
			...
			return false;
					...
					<table class="table table-bordered table-striped table-condesed" id="hidden-table-info">
						...
						<tbody>
						<?php foreach($galeriai as $item): ?>
						<tr>
							<td><img src="<?php echo $item['ubicacion']?>" width="100" height="auto"></td>
							<td><?php echo $item['nombre']?></td>
							<td><?php echo $item['descripcion']?></td>
							<td>
								<form action="eliminarGaleriai.php" method="POST">
							...
							<td>
								<a href="guardarGaleriai.php?idImagen=<?php echo $item['idImagen'] ?>"><button class="btn btn-primary">Actualizar</button></a>
