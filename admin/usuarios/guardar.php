  ...
  <section id="main-content">
    <section class="wrapper">
     <div class="row mt">
		...
		<div class="form-group col-sm-4">
		<label>Nombre</label>
			<input type="text" name="nombre" class="form-control validar" pattern="[A-Za-zÁáÉéÍíÓóÚúÑn ]+" id="validar" onchange="validarEspacio()" placeholder="Nombre" value="<?php echo $usuario->getNombreUser() ?>" required/>
		</div>
		<div class="form-group col-sm-4">
			<label>Apellidos</label>
			<input type="text" name="apellidos" pattern="[A-Za-zÁáÉéÍíÓóÚúÑn ]+" onchange="validarEspacio()" id="validar" class="form-control validar" placeholder="Apellidos" value="<?php echo $usuario->getApellidosUser() ?>" required/>
		</div>
		<div class="form-group col-sm-4">	
		<label> Email </label>
